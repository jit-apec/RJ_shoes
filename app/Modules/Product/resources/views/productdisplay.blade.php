                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a
                                        href="{{ url('/admin/product/display') }}">Product</a></li>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                @foreach ($product as $product)
                                    <div class="col-12" id="img-container"
                                        style="height:70%; width:90%; border:1px rgb(179, 204, 179) solid;">
                                        <a href="{{ asset('storage/media/' . $product->image) }}" class="minipic"
                                            title="Cartoon Bike"> <img
                                                src="{{ asset('storage/media/' . $product->image) }}" height="50"
                                                width="50" class="product-image" alt="Product Image"></a>
                                    </div>
                                    ...
                                    <div class="col-12 product-image-thumbs">
                                        ...
                                        <div class="product-image-thumb"><img
                                                src="{{ asset('storage/media/' . $product->images) }}"
                                                alt="Product Image"></div>
